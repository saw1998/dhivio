  ...
  async run() {
    ...
    const erp = cluster.addService("CarbonERPService", {
      ...
      environment: {
        ...
        DOMAIN: process.env.DOMAIN ?? "dhivio.com",
        ERP_URL: process.env.URL_ERP ? `https://${process.env.URL_ERP}` : "https://itar.dhivio.com",
        ...
        MES_URL: process.env.URL_MES ? `https://${process.env.URL_MES}` : "https://mes.itar.dhivio.com",
        NODE_ENV: "production",
        ...
        RESEND_DOMAIN: process.env.RESEND_DOMAIN ?? "dhivio.com",
        ...
        VERCEL_URL: process.env.URL_ERP ?? "itar.dhivio.com",
    ...
    const mes = cluster.addService("CarbonMESService", {
      ...
      loadBalancer: {
        domain: {
          name: process.env.URL_MES ?? "mes.itar.dhivio.com",
          dns: false,
      ...
      environment: {
        ...
        SUPABASE_URL: process.env.SUPABASE_URL,
        VERCEL_ENV: "production",
        VERCEL_URL: process.env.URL_MES ?? "mes.itar.dhivio.com",
      },
      transform: {
        loadBalancer: {
          idleTimeout: 600,
